    ...
    return (
        <div>
            ...
            <div className="text_medidas">
                <p>
                A manutenção preventiva faz parte da direção segura e é uma forma de prevenir possíveis falhas ou defeitos no seu veículo antes que eles se tornem mais graves e comprometam sua segurança e seu bolso. Ao realizar as revisões periódicas recomendadas pelo fabricante, você garante que seu veículo esteja sempre em boas condições de uso e evita surpresas desagradáveis na estrada.
                Além disso, essa abordagem contribui para a valorização do veículo no mercado, pois demonstra que você cuidou bem dele e que ele está em conformidade com as normas técnicas e ambientais. Isso pode fazer uma grande diferença na hora de vender ou trocar seu carro, moto ou caminhão.</p>
            </div>
