            ...
            <div className="menu">
                <nav>
                    <ul>
                        ...
                        <li><Link className='link_menu' href="/carro">CASASTRE SEU CARRO</Link></li>
                        <li><Link className='link_menu' href="https://web-chat.global.assistant.watson.appdomain.cloud/preview.html?region=us-south&integrationID=250f2872-90d1-4b69-a463-e7c03c0581c9&serviceInstanceID=cd14777c-39ac-401b-938f-9849d2bb018f">
                            ASSISTENTE VIRTUAL</Link></li>
